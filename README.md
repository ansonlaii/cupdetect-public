...
Due to copyright, private datasets and deployed model can not be provided.

## Public Dataset Acknowledgment
...
The kaggle dataset and yolo datasets in roboflow is used for training a YOLO model in this project. The task of this project is not necessarily related to the author's work.
